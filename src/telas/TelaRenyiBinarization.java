 ...
 * @author André Couto
 */
public class TelaRenyiBinarization extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Binarização Renyi para Imagens de uma Pasta");
	...
	private void btnSelPastaOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelPastaOrigemActionPerformed
		...
		try{
			...
			Logger.getLogger(TelaRenyiBinarization.class.getName()).log(Level.SEVERE, null, ex);
		}  
...
//								BufferedImage imagemProcessada = ProcessamentoImagem.riRedEyes(imgOriginal);
								BufferedImage imagemBinarizada = ProcessamentoImagem.RenyiBinarization(imgOriginal); 

								File fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_BinRenyi"+".png");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TelaRenyiBinarization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new TelaRenyiBinarization().setVisible(true);
			}
		});
	}
